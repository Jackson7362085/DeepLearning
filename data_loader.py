...
class DataLoader():
    ...
    def load_data(self, domain, batch_size=1, is_testing=False):      # 从数据集中取出batch_size个
    ...
    def load_batch(self, batch_size=1, is_testing=False):               # 一个数据集需要n_batches轮取数操作
        ...
        path_A = np.random.choice(path_A, total_samples, replace=False)  # 排除取相同的数
